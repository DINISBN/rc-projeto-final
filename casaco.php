...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/casaco.css">
        ...
        <div class="produto">
            ...
            <div class="imagem-lado">
                ...
                <div class="imagem-principal">
                    ...
                    $imagem = isset($_GET['img']) && $_GET['img'] == 'costas' ? 'img/cunha.png' : 'img/casaco1.png';
                    ?>
                ...
                <div class="miniaturas">
                    <div class="miniatura">
                        <a href="?img=frente">
                            <img src="img/casaco1.png" alt="Frente">
                        </a>
                    </div>
                    <div class="miniatura">
                        <a href="?img=costas">
                            <img src="img/cunha.png" alt="Costas">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="info-produto">
                <h1 class="titulo">Casaco 2025/26</h1>
                
                <div class="preco">
                    44€ EUR
                    <span class="preco-antigo">55€ EUR</span>
                </div>
                ...
                <div class="descricao">
                    ...
                    Casaco oficial para a época 2025/26. 
